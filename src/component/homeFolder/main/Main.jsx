    ...
    <div className="mContainer white">
      ...
      <div className="rightMContainer">
        <motion.div
          ...
          animate="animate"
          initial="initial"
          transition={{ duration: 0.5, delay: 2.1, yoyo: Infinity }}
        ></motion.div>
        <motion.div
          className="two"
          variants={creativeVariant}
          animate="animate"
          initial="initial"
          transition={{ duration: 0.5, delay: 2.3, yoyo: Infinity }}
        ></motion.div>
        <motion.div
          className="three"
          variants={creativeVariant}
          animate="animate"
          initial="initial"
          transition={{ duration: 0.5, delay: 2.5, yoyo: Infinity }}
        ></motion.div>
        <motion.div
          className="four"
          variants={creativeVariant}
          animate="animate"
          initial="initial"
          transition={{ duration: 0.5, delay: 2.7, yoyo: Infinity }}
        ></motion.div>
        <motion.div
          className="five"
          variants={creativeVariant}
          animate="animate"
          initial="initial"
          transition={{ duration: 0.5, delay: 2.9, yoyo: Infinity }}
        ></motion.div>
        <motion.div
          className="six"
          variants={creativeVariant}
          animate="animate"
          initial="initial"
          transition={{ duration: 0.5, delay: 3.1, yoyo: Infinity }}
        ></motion.div>
        <motion.div
          className="seven"
          variants={creativeVariant}
          animate="animate"
          initial="initial"
          transition={{ duration: 0.5, delay: 3.3, yoyo: Infinity }}
        ></motion.div>
      </div>
      <motion.div
