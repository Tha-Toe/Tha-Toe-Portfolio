...
function Thankyou () {
    ...
    return(
        <AnimatePresence exitBeforeEnter>
            {showModal && (
                <motion.div className = "thankContainer"
                ...
                >
                    ...
                    <Link to="/">
                        <button className="backButton" onClick={() => setShowModal(false)}><FontAwesomeIcon icon={faRotateBack} className="backIcon"/>Go Back</button>
                    </Link>
                </motion.div>
            )}
